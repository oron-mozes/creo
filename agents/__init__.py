...
# All agent directories now use underscores (Python package naming convention)
import importlib.util
from pathlib import Path

_agents_dir = Path(__file__).parent

# Load orchestrator_agent (contains root_agent)
_orchestrator_path = _agents_dir / 'orchestrator_agent' / 'agent.py'
...
_creator_finder_path = _agents_dir / 'creator_finder_agent' / 'agent.py'
...
# Load campaign_brief_agent
_campaign_brief_path = _agents_dir / 'campaign_brief_agent' / 'agent.py'
_campaign_brief_spec = importlib.util.spec_from_file_location('campaign_brief_agent', _campaign_brief_path)
_campaign_brief_module = importlib.util.module_from_spec(_campaign_brief_spec)
_campaign_brief_spec.loader.exec_module(_campaign_brief_module)
campaign_brief_agent = _campaign_brief_module.campaign_brief_agent

# Load outreach_message_agent
_outreach_message_path = _agents_dir / 'outreach_message_agent' / 'agent.py'
...
# Load campaign_builder_agent
_campaign_builder_path = _agents_dir / 'campaign_builder_agent' / 'agent.py'
