...
class TestBusinessCard:
    ...
    def test_business_card_creation_with_all_fields(self):
    ...
    def test_business_card_website_url_validation(self):
    ...
    def test_business_card_optional_fields(self):
    ...
    def test_business_card_to_dict(self):
    ...
    def test_business_card_to_dict_with_none_values(self):
    ...
    def test_business_card_is_complete_with_website(self):
    ...
    def test_business_card_is_complete_with_social_links(self):
    ...
    def test_business_card_is_complete_with_both_contact_methods(self):
    ...
    def test_business_card_is_not_complete_missing_name(self):
    ...
    def test_business_card_is_not_complete_missing_contact(self):
    ...
    def test_business_card_is_not_complete_missing_location(self):
    ...
    def test_business_card_is_not_complete_missing_service_type(self):
    ...
    def test_business_card_not_provided_string_treated_as_missing(self):
